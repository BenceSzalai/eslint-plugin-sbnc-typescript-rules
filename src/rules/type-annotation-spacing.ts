...
interface WhitespaceRule {
  ...
  readonly ignoreBefore?: boolean;
  readonly ignoreAfter?: boolean;
}
...
export default createRule<Options, MessageIds>({
  ...
  create(context, [options]) {
    ...
    function checkTypeAnnotationSpacing(
      ...
      const { before, after, ignoreBefore, ignoreAfter } = getRules(ruleSet, typeAnnotation);
